...
- T5.4 เสร็จ: มีบัญชีเจ้าของ 1 บัญชี (ยืนยันอีเมลแล้ว)
- **ตัดสินใจโดยเจ้าของ (2026-09-25):** ไม่ปิด "Allow new users to sign up" (`disable_signup` = false) ยอมรับความเสี่ยงว่าใครก็สมัครผ่าน API ได้ ข้อมูลยังแยกตามบัญชีด้วย RLS เว็บไม่มีหน้าสมัคร
- **ค้าง:** T8.2, T8.3, T8.4 (ยังไม่เคยทดลองล็อกอินจริงในเบราว์เซอร์ ควรลองบนเว็บที่ deploy) และ T8.5 ส่วนมือถือ
